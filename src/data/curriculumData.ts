...
export const BADGES_LIST: BadgeItem[] = [
  { id: 'badge-1', name: 'شارة الحاسوب والرقمنة', category: 'الذكاء التقني', icon: '💻', description: 'إتقان استخدام الحاسوب والبرمجيات البسيطة' },
  { id: 'badge-2', name: 'شارة الإسعافية الصغرى', category: 'الصحة والسلامة', icon: '🩹', description: 'تطهير الجروح البسيطة واستخدام الحقيبة الطبيّة' },
  { id: 'badge-3', name: 'شارة صديقة البيئة', category: 'الطبيعة', icon: '🌱', description: 'غرس النباتات والعناية بالحديقة وتدوير النفايات' },
  { id: 'badge-4', name: 'شارة الطاهية الصغرى', category: 'المهارات المنزلية', icon: '🍳', description: 'إعداد وجبات صحية خفيفة وترتيب المائدة' },
  { id: 'badge-5', name: 'شارة الفنانة والرسامة', category: 'الفنون والأشغال', icon: '🎨', description: 'الرسم وصنع مجسمات ورقية وحرفية' },
  { id: 'badge-6', name: 'شارة الرياضية النشيطة', category: 'اللياقة البدنية', icon: '⚽', description: 'المشاركة في الألعاب الجماعية والجمباز' },
  { id: 'badge-7', name: 'شارة الصحفية الصغيرة', category: 'الإعلام والتواصل', icon: '📰', description: 'كتابة المقالات والتصوير وإعداد صحيفة السداسي' },
  { id: 'badge-8', name: 'شارة القارئة الشغوفة', category: 'الثقافة والأدب', icon: '📚', description: 'قراءة 5 كتب والتلخيص وإلقاء القصائد' },
  { id: 'badge-9', name: 'شارة الطهي الخلوي', category: 'الكشفية', icon: '🏕️', description: 'طهي الطعام في المخيم واستخدام الموقد الخلوي' },
  { id: 'badge-10', name: 'شارة حافظة القرآن الكريم', category: 'الديني', icon: '🕌', description: 'حفظ أجزاء من القرآن الكريم والأحاديث النبوية' }
];
